from tkinter import Tk, Button, Frame, PhotoImage, Message, Canvas, Label, Listbox, Scrollbar, \
    RIGHT, X, Y, END, BOTTOM, HORIZONTAL, VERTICAL, Entry, filedialog
...
class PageDirectInput():
    ...
    def createWidgets(self):
        ...
        self.openFolder = Label(self.middle_frame, text="Language", justify='center', bg='white', fg='#EE7C7D',
                              font=("Courier", 12,))
        ...
        self.results = Entry(self.lower_frame)
        self.results.pack()
